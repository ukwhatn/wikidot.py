...
class TestOdateParse:
    ...
    def test_parse_valid_odate(self, odate_html_factory: callable) -> None:
        """有効なodate要素をパースできる"""
    ...
    def test_parse_odate_epoch(self, odate_html_factory: callable) -> None:
    ...
    def test_parse_odate_recent_timestamp(self, odate_html_factory: callable) -> None:
        """最近のタイムスタンプをパースできる"""
    ...
    def test_parse_odate_old_timestamp(self, odate_html_factory: callable) -> None:
        """古いタイムスタンプをパースできる"""
